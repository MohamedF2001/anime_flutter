...
class HiddenAnimation extends StatefulWidget {
  const HiddenAnimation({Key? key}) : super(key: key);

  @override
  State<HiddenAnimation> createState() =>
      HiddenAnimationState();
}

class HiddenAnimationState extends State<HiddenAnimation>
